    ...
    <footer className="bg-navy-deep text-white/70">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            <Link href="#pocetna" className="flex items-center gap-3 mb-5">
              <Image
                src="/logo.png"
                alt="LED Plus"
                width={96}
          ...
          <div>
            <h3
              className="font-heading font-bold text-white text-lg mb-4 tracking-wide"
              style={{ fontFamily: "var(--font-barlow), sans-serif" }}
            >
              NAVIGACIJA
            </h3>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/40">
          <span>© {new Date().getFullYear()} LED Plus. Sva prava zadržana.</span>
          <a
